<template>
    ...
    <div class="pt-60 pb-120 ovx-hidden bg-color">
        ...
        <div v-if="loadingPage"><center><h2>Loading....</h2></center> </div>

        <div class="container" v-if="count==true">
                            ...
                            <div class="row gray" >
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <button v-if="item.provider_assign_status=='done'" class=" btn btn-success" >Completed</button>&nbsp
        ...
        <div v-else-if="count==false"><center><h2>{{ this.translate('jobNotAssign') }}</h2></center> </div>
            ...
            <div class="modal-body">
                <form @submit.prevent="jobAccept">
                    ...
                    <input type="hidden"  class="form-control" readonly v-model="form.job_id" >
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group"  v-if="form.status == 'active' || form.status == 'done'">
                                ...
                                <div class="form-group"  v-else>
                                    <label  class="mb-2 semi-bold black">{{ this.translate('description') }}</label>
                                    <textarea class="form-control"  cols="30" rows="10" readonly>{{ this.translate('jobDescription') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="form-group" v-else>
                                    <label  class="mb-2 semi-bold black">{{ this.translate('name') }}</label>
                                    <input type="text"  class="form-control" readonly :value="this.translate('jobName')"  >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group" v-if="form.status == 'active' || form.status == 'done'">
                                ...
                                <div class="form-group" v-else>
                                    <label  class="mb-2 semi-bold black">{{ this.translate('email') }}</label>
                                    <input type="text"  class="form-control" readonly :value="this.translate('jobEmail')"  >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group" v-if="form.status == 'active' || form.status == 'done'">
                                ...
                                <div class="form-group" v-else>
                                    <label  class="mb-2 semi-bold black">{{ this.translate('phone') }}</label>
                                    <input type="text"  class="form-control" readonly :value="this.translate('jobPhone')"  >
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group" v-else>
                                    ...
                                    <input type="text"  class="form-control" readonly :value="this.translate('jobAddress')" >
                                </div>
                            </div>
                    ...
                    <div style="float:right" v-if="form.status=='pending'">
                        <button v-if="!loading" type="submit"   class="btn btn-primary waves-effect waves-light" >{{ this.translate('accept') }}</button>
                        <button v-else class="btn btn-success waves-effect waves-light" >Loading....</button>
                    </div>
...
export default {
    ...
    created() {
                ...
                if(provider.status=='Block'){
                    this.$router.push({name:"ProviderBlock"});
                }
                else{
                    this.fetchData()
                }
