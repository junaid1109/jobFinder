                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="email" id="email" class="form-control" v-bind:autocomplete="autocompleteValue" :placeholder="this.translate('email')" v-model="v$.form.email.$model">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="phone" class="form-control"  v-model="v$.form.phone.$model" :placeholder="this.translate('phone')">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="address" class="mb-2 semi-bold black">{{ this.translate('city') }}</label> 
                                        <select id="address" class="form-control" v-model="v$.form.address.$model">
                                            <option value="" disabled>{{ this.translate('city') }}</option>
...
export default {
    ...
    methods: {
                ...
                async saveProvider() {
                    ...
                    axios.post(this.$authentication+'provider_update',parameters)
                        .then(response => {
