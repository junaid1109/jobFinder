                        ...
                        <div class="form-wrap login-form-wrap style--two form-border">
                            ...
                            <div v-if="currentTab === 0">
                                ...
                                <div class="tab" v-show="currentTab === 2">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-3 g-4 image-gallery">
                                    </div>
                                    <br>
        ...
        if (input.files && input.files.length > 0) {
            for (let i = 0; i < input.files.length; i++) {
                ...
                reader.onload = function (e) {
                    ...
                    // Append each image to the gallery with a delete button
                    $('.image-gallery').append(
                        `<div class="col-lg-3">
                            <div class="col image${i}">
                                <div class="card h-100">
                                    <a data-fancybox="gallery" href="${imageUrl}">
                                        <img src="${imageUrl}" class="thumbnail" class="card-img-top"/>
                                    </a>
                                    <div class="card-footer">
                                        <button type="button" class="delete-btn form-control  text-center" onclick="deleteImage('.image${i}')">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>`
