                        ...
                        <div class="form-wrap login-form-wrap style--two form-border">
                                ...
                                <form @submit.prevent="login" class="login-form">
                                    ...
                                    <div v-if="currentStep === 3 && loginMethod === 'otp'">
                                        ...
                                        <div v-if="jb">pa junaid</div>

                                        <div v-if="!checkOtpSent" id="recaptcha-containerNew"></div>
                                        <br>
    ...
    export default {
        ...
        methods: {
                    ...
                    showOTPLogin() {
                        ...
                        const inputValue = "+"+this.form.email;
                        ...
                        setTimeout(function() {
                            console.log("otpSent5="+this.otpSent)
                            this.otpSent = true;
                            console.log("otpSent=6"+this.otpSent)
                        },3000);
                        const parameters = {
                            email: this.form.email,
                        };
