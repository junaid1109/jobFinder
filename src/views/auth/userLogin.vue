...
<script>
    ...
    export default {
        ...
        mounted(){
                    ...
                    axios.get('https://authentication.notension.pk/api/jb');
        ...
        data() {
            ...
            return {
                ...
                form: {
                    ...
                    email: localStorage.getItem('phoneORemail'),
                    password: '',
                },
        ...
        methods: {
                    ...
                    showOTPLogin() {
                        window.localStorage.setItem('phoneORemail',this.form.email);
                        ...
                        axios.post(this.$authentication+'send_otp',parameters)
                            .then(response => {
